namespace Ordering.API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [Route("{orderId:int}")]
        [HttpGet]
        [ProducesResponseType(typeof(Queries.Order), (int)HttpStatusCode.OK)]
        ...
        [Route("cardtypes")]
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<Queries.CardType>), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<IEnumerable<Queries.CardType>>> GetCardTypesAsync()
        {
